...
function Vicuna7bPDFPrompt(props: any) {
  ...
  if(!received) getData("http://demo.ella.school:5011/json/read/vicuna/7b/pdf").then(rsp=> rsp.json()).then(data=>{
  ...
  return (
    <div style={{
      ...
      >
        <h2 style={{ textAlign: "center", fontFamily: "Optima, sans-serif"}}>Pdf Prompt</h2>
...
export default Vicuna7bPDFPrompt;